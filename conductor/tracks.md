...
Execution policy: [continuous autonomous execution](./autonomy.md). After
authorisation, proceed through tasks, phases, reviews, checkpoints, and the next
...
- [x] **Track: Track 20: Semantic Knowledge Graph, Hybrid Vector Search, and Automated Webhook Dispatch**
...
- [x] **Track: Track 1: Consolidation baseline and migration authority**
...
- [x] **Track: Track 6: Preservation, replay and recovery assimilation**
...
- [x] **Track: Track 7: Publication and archive-distribution alignment**
...
- [x] **Track: Track 8: CLI/MCP and operator-interface convergence**
...
- [x] **Track: Track 11: Capability assimilation and architectural refactor**
...
- [x] **Track: Track 12: Release cutover and publication continuity**
...
- [x] **Track: Track 13: Observation, donor deprecation and archival**
...
- [x] **Track: Track 14: Post-consolidation extension and RIOPA interoperability**
...
- [x] **Track: Track 15: Consolidation closeout and operational readiness**
...
- [x] **Track: Legislation Corpus Consolidation Parent Programme**
  *Link: [tracks/legislation_corpus_consolidation_corrective_20260818/index.md](./tracks/legislation_corpus_consolidation_corrective_20260818/index.md)*
  - [x] **Track: Child Track 1: Evidence correction and chronology**
  ...
  - [x] **Track: Child Track 2: Live inventory and reuse analysis**
  ...
  - [x] **Track: Child Track 3: Standards and schema conformance**
  ...
  - [x] **Track: Child Track 4: Existing adapter and donor-client integration**
  ...
  - [x] **Track: Child Track 5: Legislation identity, normalisation and corpus services**
  ...
  - [x] **Track: Child Track 5A: Legislation service integrity correction**
  ...
  - [x] **Track: Child Track 6A: Fail-closed service-backed legislation CLI correction**
    *Link: [tracks/legislation_cli_service_backing_20260820/index.md](./tracks/legislation_cli_service_backing_20260820/index.md)*
  - [x] **Track: Child Track 7: MCP disposition and conformance**
  ...
  - [x] **Track: Child Track 7A: Current-standard fail-closed MCP correction**
    *Link: [tracks/mcp_current_standard_correction_20260820/index.md](./tracks/mcp_current_standard_correction_20260820/index.md)*
  - [x] **Track: Child Track 8: Weekly orchestration and persistent state**
  ...
  - [x] **Track: Child Track 8A: Fail-closed legislation workflow correction**
    *Link: [tracks/legislation_workflow_fail_closed_20260820/index.md](./tracks/legislation_workflow_fail_closed_20260820/index.md)*
  - [x] **Track: Child Track 9: Historical reconciliation, parity and publication identity**
  ...
  - [x] **Track: Child Track 9A: Fail-closed one-batch reconciliation correction**
  ...
  - [x] **Track: Child Track 10: Rights and redistribution**
  ...
  - [x] **Track: Child Track 11: Shadow operation, recovery and cutover**
  ...
  - [x] **Track: Child Track 12: Gazette residual work — separation decision recorded**
...
- [x] **Track: Surveillance Heartbeat Ledger & Cross-Repository Federation Protocol**
  *Link: [archive/bronze_surveillance_and_federation_anchoring_20260823/index.md](./archive/bronze_surveillance_and_federation_anchoring_20260823/index.md)*
...
- [x] **Track: Common Multi-Platform Publication & Distribution Hub**
  *Link: [archive/common_publication_distribution_hub_20260823/index.md](./archive/common_publication_distribution_hub_20260823/index.md)*
...
- [~] **Track: Global FOI source catalogue, metadata and public raw archive**
  ...
  *Approved 2026-08-30: archive-govt-nz takeover with fyi-cli capture; execution in progress, no cutover claimed.*

- [x] **Track: Historical legislation consolidation programme (superseded)**
  *Link: [./tracks/legislation_corpus_consolidation_20260818/index.md](./tracks/legislation_corpus_consolidation_20260818/index.md)*
  *Historical completion only; superseded_by is retained in metadata.*

- [x] **Track: Imported donor snapshot container catalogue**
  *Link: [archive/imported/index.md](./archive/imported/index.md)*
- [x] **Track: RIOPA interoperability integration**
...
- [~] **Track: Prompt 16 Zenodo concept/version DOI correction**
