...
- [x] **Track 4: Canonical archive contracts**
...
- [x] **Track 8: CLI/MCP and operator-interface convergence**
...
- [x] **Track 13: Observation, donor deprecation and archival**
...
- [x] **Legislation Corpus Consolidation Parent Programme**
  *Link: [tracks/legislation_corpus_consolidation_corrective_20260818/index.md](./tracks/legislation_corpus_consolidation_corrective_20260818/index.md)*
  ...
  - [x] **Child Track 5B: Global CLI integrity correction**
  ...
  - [x] **Child Track 6A: Fail-closed service-backed legislation CLI correction**
  ...
  - [x] **Child Track 7A: Current-standard fail-closed MCP correction**
  ...
  - [x] **Child Track 8A: Fail-closed legislation workflow correction**
  ...
  - [x] **Child Track 9A: Fail-closed one-batch reconciliation correction**
