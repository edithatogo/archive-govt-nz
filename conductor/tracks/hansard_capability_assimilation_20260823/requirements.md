# Requirements: Hansard Corpus Capability Assimilation

- **Track ID:** `hansard_capability_assimilation_20260823`
- **Upstream / Donor:** `edithatogo/corpus-nz-hansard`
- **Consolidation Mode:** Selective capability assimilation into archive_govt_nz/domains/hansard/

## 1. Functional Requirements (MoSCoW)
### 1.1 MUST Have
- **MUST-1:** Leverage existing upstream assets: Debate XML parsers, MP/Speaker models, parliamentary speech schemas, Parquet builders.
