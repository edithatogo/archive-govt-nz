...
| Is everything public on Hugging Face? | The source catalogue and its indexes are public. The Canadian ATIP nil-return package is now public on Hugging Face with anonymous restore and viewer verification; US originals and NZ correspondence/attachments remain private or quarantined pending field-level review. Historical destination visibility does not prove raw completeness. |
| How many remain? | All 250 geographic entities plus EU remain unverified for complete coverage. 255 named sources currently seed the discovery ledger; all 251 entities now have at least one named source. Named-source discovery is complete for all 251 entities; capture completeness and rights review remain outstanding. This is not a sovereign-country count, and no global request denominator is known. |
