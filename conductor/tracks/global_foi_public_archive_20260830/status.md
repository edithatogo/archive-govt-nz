...
| How many remain? | All 250 geographic entities plus EU remain unverified for complete coverage. 197 named sources currently seed the discovery ledger; 58 entities have no named source yet. Broader discovery is still required for all 251 entities. This is not a sovereign-country count, and no global request denominator is known. |
