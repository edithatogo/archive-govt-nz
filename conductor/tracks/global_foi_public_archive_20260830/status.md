...
| How many remain? | All 250 geographic entities plus EU remain unverified for complete coverage. 255 named sources currently seed the discovery ledger; all 251 entities now have at least one named source. Broader discovery is still required for all 251 entities. This is not a sovereign-country count, and no global request denominator is known. |
