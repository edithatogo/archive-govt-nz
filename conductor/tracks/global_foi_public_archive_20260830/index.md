...
- [Baseline receipts](./evidence.md)
- [Run log](./runlog.md)
- [Self-review](./review.md)
- [Approval and ownership decision](./approval.json)
- [Additional recommendations](./recommendations.md)
- [Initialization validation](./validation-report.json)
