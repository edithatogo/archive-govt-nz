...
- [x] P2.2 (AC04): Implement one registry and importer reconciling all 23 runtime instances, 29 sites and 42 target regimes; represent every country with reviewed sources or an explicit evidence-backed disposition. Bounded registry/disposition acceptance: `ordered-delivery-20260907.md`, PR #423; not capture completeness.
- [x] P2.3 (AC04, AC09): Generate the public source index, machine coverage ledger and human report; keep unknown denominators null and states distinct. Generation acceptance: `ordered-delivery-20260907.md`, PR #423; external publication remains P4.
...
- [x] P5.4a review fix (AC09, AC12): Distinguish terminal control rehearsals
  ...
  (PR #395 merged c3504f9; seven hosted checks passed)
