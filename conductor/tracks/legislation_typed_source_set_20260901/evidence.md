...
Focused result: 124 passed; `archive_govt_nz.source_sets` reached 100% statement and branch coverage. Expanded isolated mutation result: 14/14 killed; receipt `/Volumes/PortableSSD/Quarantine/archive-govt-nz/source-set-11/mutation-reviewed.json`, source SHA-256 `2504be56411c5e57abc0dfa1186b755185c81be5e48c65508215e8ca4ef64f4e`.

Native harness retry passed with one xdist worker after the four-worker Python 3.14/macOS collection attempt bus-faulted: 4,267 tests, 97.29% repository coverage, schema 44/34, parity 9/9, all native mutation lanes, dependency audit, licence inventory, secret scan and 111-component SBOM. Validation receipt: `evidence/migrations/corpus-legislation-nz/source-set-contract/validation.json`. Actionlint reports only two unchanged base findings in unrelated workflows (SC2086 at global CKAN line 56 and scheduled Gazette line 36).
