...
- [x] Inventory legislation fields and both partial consumers.
- [x] Add red contract, failure and consumer tests.
- [x] Implement schema, typed loader, direct dependency and v1 migration.
