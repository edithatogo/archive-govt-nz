# Plan: Global CLI integrity correction

- [x] **Phase 1:** Replace archive, replay, and global verification stubs with
  production-layout and structural/fixity validation.
- [x] **Phase 2:** Connect provenance and search commands to validated real
  local evidence.
...
- [~] **Phase 4B — Final CAS boundary fix:** Reject an internal `sha256`
