# Requirements: Medico-Legal Case Law Preservation Machinery

- **Track ID:** `corpus_medilegal_preservation_machinery_20260823`
- **Upstream / Donor:** `edithatogo/corpus-cases-medilegal-nz`
- **Consolidation Mode:** Shared preservation/publication machinery assimilation; corpus remains independently versioned

## 1. Functional Requirements (MoSCoW)
### 1.1 MUST Have
- **MUST-1:** Leverage existing upstream assets: Judgment/decision citation graphs, anonymization verification gates, tribunal record normalizers.
