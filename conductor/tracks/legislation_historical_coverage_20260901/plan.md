...
- [x] Audit primary donor, target-state, parity and public-surface evidence in parallel.
- [x] Implement deterministic population-separated coverage analysis and schema.
