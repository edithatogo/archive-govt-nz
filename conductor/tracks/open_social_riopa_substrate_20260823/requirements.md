# Requirements: Open Social Data & RIOPA Interoperability Substrate

- **Track ID:** `open_social_riopa_substrate_20260823`
- **Upstream / Donor:** `edithatogo/open_social_data and RIOPA public-data tooling`
- **Consolidation Mode:** Shared archival/publication infrastructure for public social datasets

## 1. Functional Requirements (MoSCoW)
### 1.1 MUST Have
- **MUST-1:** Leverage existing upstream assets: Bluesky/Threads/X/YouTube capture pipelines, RIOPA archive export receipts, CAS media storage.
