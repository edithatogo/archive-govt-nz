...
- [x] Task: Establish track, MoSCoW requirements, design, and GitHub hierarchy
  - [x] Create parent issue and nested phase subissues
  - [x] Record immutable ArchiveBox image identity and bounded pilot scope
- [x] Task: Add canonical reusable architecture documentation
  - [x] Add repository Mermaid document and reuse guidance
  - [x] Add generated Hugging Face card reference and future Zenodo package input
