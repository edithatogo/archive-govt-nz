# Requirements: HathiTrust NZ Historic Corpus Capability Assimilation

- **Track ID:** `hathi_nz_capability_assimilation_20260823`
- **Upstream / Donor:** `edithatogo/hathi-nz`
- **Consolidation Mode:** Selective capability assimilation with strict source-rights boundary preservation

## 1. Functional Requirements (MoSCoW)
### 1.1 MUST Have
- **MUST-1:** Leverage existing upstream assets: Volume/page metadata parsers, OCR text normalizers, rights classification logic.
