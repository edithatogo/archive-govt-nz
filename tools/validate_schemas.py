...
VALIDATION_PAIRS = (
    (
        ...
        / "tests"
        / "fixtures"
        / "legislation-github-release-correction-v1.json",
    ),
    (
        REPOSITORY_ROOT / "schemas" / "legislation-evidence-index-v1.schema.json",
        REPOSITORY_ROOT / "tests" / "fixtures" / "legislation-evidence-index-v1.json",
    ),
    (
        REPOSITORY_ROOT / "schemas" / "legislation-harvest-receipt-v3.schema.json",
        REPOSITORY_ROOT / "tests" / "fixtures" / "legislation-harvest-receipt-v3.json",
    ),
    (
        REPOSITORY_ROOT / "schemas" / "source-set-v2.schema.json",
        REPOSITORY_ROOT / "tests" / "fixtures" / "source-set-discovery-v2.json",
    ),
    (
        REPOSITORY_ROOT / "schemas" / "source-set-v2.schema.json",
        REPOSITORY_ROOT / "tests" / "fixtures" / "source-set-exact-inventory-v2.json",
    ),
    (
    ...
    (
        REPOSITORY_ROOT / "schemas" / "health-budget-verification-v1.schema.json",
        REPOSITORY_ROOT
        / "tests"
        / "fixtures"
        / "health-budget-verification-sample-v1.json",
    ),
    (
