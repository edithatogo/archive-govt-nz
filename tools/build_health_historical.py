"""Extract historical Health/GDP currency observations into new Silver output."""
...
def main() -> int:
    """Require verified inputs and explicit observation context; never publish."""
    ...
    result = normalize_historical_workbook(
        args.source,
        args.output_dir,
